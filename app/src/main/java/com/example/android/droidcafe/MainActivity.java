...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_nama = findViewById(R.id.textintro);
        tv_nama.setText(Preferences.getLoggedInUser(getBaseContext()));
    }
     ...
     */
    public void showAirjordanOrder(View view) {
        mOrderMessage = getString(R.string.airjordan1_order_message);
     ...
     */
    public void showcrorder(View view) {
        mOrderMessage = getString(R.string.cr_order_message);
        displayToast(mOrderMessage);
    }
