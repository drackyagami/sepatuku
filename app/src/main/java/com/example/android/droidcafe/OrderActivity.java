...
public class OrderActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText nama = findViewById(R.id.name_text);
        EditText alamat = findViewById(R.id.address_text);
        EditText phone = findViewById(R.id.phone_text);
        EditText email = findViewById(R.id.kp_text);
        EditText size =findViewById(R.id.note_text);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(OrderActivity.this,tampilanorder.class);
